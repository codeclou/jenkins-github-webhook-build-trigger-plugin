...
:sparkles: Download: [`github-webhook-notifier-plugin-1.1.0.hpi.zip`](https://github.com/codeclou/jenkins-github-webhook-build-trigger-plugin/releases/download/1.1.0/github-webhook-notifier-plugin-1.1.0.hpi.zip)
